...
<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
    ...
    <div class="col-sm-4">
        ...
        <div class="col-sm-3"><p><strong>Phone:</strong></p></div>
				<div class="col-sm-9"><p><?php the_field('phone'); ?></p></div>
        <div class="col-sm-3"><p><strong>Email:</strong></p></div>
        <div class="col-sm-9"><p><?php the_field('email'); ?></p></div>
        </div>
        <div class="primary-info-sidebar">
        ...
        <div class="col-sm-3"><p><strong>Phone:</strong></p></div>
				<div class="col-sm-9"><p> (855) 377-3511</p></div>
        <div class="col-sm-3"><p><strong>Email:</strong></p></div>
        <div class="col-sm-9"><p>sales@empirefiretrucks.com</p></div>
        </div>
    </div>
</article>
<?php endwhile; ?>
